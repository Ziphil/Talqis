...
describe("from raw date object", () => {
  ...
  test("G2018/10/08 02:27:16.092 (random after epoch 4)", () => {
  ...
  test("G2031/11/07 00:05:38.925 (random after epoch 8)", () => {
  ...
  test("G2001/08/25 05:01:00.187 (random before epoch 2)", () => {
